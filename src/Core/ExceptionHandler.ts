/**
 * @module      NetSuiteEssentials
 * @class       ExceptionHandler
 * @description ExceptionHandler to handle the NetSuite & JavaScript exceptions
...
class ExceptionHandler implements ExceptionHandlerInterface {
    ...
    private emailRecipients: string[] = ['devineers@gmail.com'];
    private subsidiaryName: string = 'Devineers';
    code: string;
    message: string;
    stack: string;
